								...
								foreach ($results as $row) {               ?>
									...
									<div class="content-wrap">
										...
										<ul class="meta pb-20">
											...
											<br>
											<li><strong>Date of Publishcation: </strong>Comming Soon</li>
										</ul>
										<p>
											<b><b><?php echo htmlentities($row->MagazineDescription) ?></b></b>
										</p>
										<p align="center" style="padding-top: 20px;">
											<button class="btn success" data-toggle="modal" data-target="#myModal"><b>VIEW MORE</b></button>
										</p>
										<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
											<div class="modal-dialog" role="document">
												<div class="modal-content">
													<div class="modal-header">
														<h5 class="modal-title" id="exampleModalLabel">This magazine will be released soon!</h5>
