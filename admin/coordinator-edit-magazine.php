...
if (strlen($_SESSION['oesaid'] <= 2)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        echo "<script>window.location.href ='coordinator-new-magazine.php'</script>";
    }
?>
    <!DOCTYPE html>
    <html lang="en">
                                                ...
                                                foreach ($results as $row) {               ?> <div class="form-row">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-4">
                                                            ...
                                                            <p>
                                                                <img src="../user/images/<?php echo $row->CoverImage; ?>" width='724' height='468'><a href="coordinator-changeimage.php?editid=<?php echo $row->mid; ?>"> &nbsp; <br><br><strong style="color: red">(Upload new Image)</strong></a>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-4">
                                                            ...
                                                            <a href="../user/files/<?php echo $row->UploadMagazine; ?>" width="100" height="100" target="_blank"><strong style="color: blue"><i>Download Uploaded Magazine</i></strong></a> </a>
                                                            <a href="coordinator-changefile.php?editid=<?php echo $row->mid; ?>"> &nbsp;<strong style="color: red"> (Upload new file)</strong></a>
                                                        </div>
                                                    </div>
                                            <?php $cnt = $cnt + 1;
                                                }
