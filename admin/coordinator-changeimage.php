...
if (strlen($_SESSION['oesaid'] <= 2)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            move_uploaded_file($_FILES["coverimage"]["tmp_name"], "../user/images/" . $coverimage);
...
?>
    ...
    <head>
        ...
        <title>Annual University Magazine FPT University of Greenwich - Update Magazine Cover</title>
                                    ...
                                    <div class="widget-header">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                <h4 style="color:red">UPDATE MAGAZINE IMAGE COVER</h4>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                foreach ($results as $row) {               ?> <div class="form-row">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-4">
                                                            ...
                                                            <br>
                                                            <img src="../user/images/<?php echo $row->CoverImage; ?>" width='724' height='468'>

                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col-md-12 mb-4">
                                                            <label><b>New Cover Image:</b></label>
