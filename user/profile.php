                                ...
                                <div class="statbox widget box box-shadow">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 mb-4">
                                            ...
                                            <input type="text" value="<?php echo $row->Faculty; ?>" class="form-control" name="faculty" readonly="true">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-12 mb-4">
                                            <label for="fullName"><b>Role:</b></label>
                                            <input type="text" value="<?php echo $row->Role; ?>" class="form-control" name="role" readonly="true">
                                        </div>
                                    </div>
